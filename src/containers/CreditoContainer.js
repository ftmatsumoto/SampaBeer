...
class CreditoContainer extends Component {
  render() {
    let message = `CREDITO - The viewport's current media type is: ${this.props.browser.mediaType}.`
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(CreditoContainer));
